 ...
 */
void
gi_marshalling_tests_utf8_none_out (const char **utf8)
{
 ...
 */
void
gi_marshalling_tests_utf8_none_inout (const char **utf8)
{
  g_assert_cmpstr (GI_MARSHALLING_TESTS_CONSTANT_UTF8, ==, *utf8);
  *utf8 = "";
}
...
{
  static const char *values[] = { "0", "1", "2", NULL };
  return values;
}
 ...
 */
void
gi_marshalling_tests_array_zero_terminated_out (const char ***utf8s)
{
  static const char *values[] = { "0", "1", "2", NULL };
  *utf8s = values;
}
 ...
 */
void
gi_marshalling_tests_array_zero_terminated_inout (const char ***utf8s)
{
  static const char *values[] = { "-1", "0", "1", "2", NULL };

  g_assert (g_strv_length ((char **) (*utf8s)));
  g_assert_cmpstr ((*utf8s)[0], ==, "0");
  g_assert_cmpstr ((*utf8s)[1], ==, "1");
  g_assert_cmpstr ((*utf8s)[2], ==, "2");
...
{
  static GArray *internal = NULL;
  static const char *values[] = { "-2", "-1", "0", "1", NULL };
  gint i;
...
{
  static const char *val1 = "-2";
  static const char *val2 = "-1";
  static const char *val3 = "0";
  static const char *val4 = "1";
  GArray *result;
...
{
  static const char *val1 = "-1";
  static const char *val2 = "-2";
  gchar *val;
  GArray *result;
...
gi_marshalling_tests_gptrarray_utf8_none_return (void)
{
  ...
  static const char *values[] = { "0", "1", "2" };
  gint i;
...
gi_marshalling_tests_gerror_out_transfer_none (GError **err, const gchar **debug)
{
  static GError error = { 0,
    GI_MARSHALLING_TESTS_CONSTANT_GERROR_CODE,
    (char *) GI_MARSHALLING_TESTS_CONSTANT_GERROR_MESSAGE
  };
